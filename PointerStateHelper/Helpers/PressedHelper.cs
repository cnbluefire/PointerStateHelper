...
{
    public class PressedHelper
    {
        private const string BackgroundNames = "rootgrid,buttonlayoutgrid,contentpresenter,borderelement,searchboxgrid,background";
        ...
        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.RegisterAttached("Background", typeof(Brush), typeof(PressedHelper), new PropertyMetadata(null,async (s, a) =>
            {
                if(a.NewValue != a.OldValue)
                {
                    if(s is FrameworkElement ele)
                    {
                        ...
                        {
                            var storyboard = commonStates.States.FirstOrDefault(x => x.Name == "Pressed")?.Storyboard;
                            if(storyboard != null)
                            {
        ...
        public static readonly DependencyProperty ForegroundProperty =
            DependencyProperty.RegisterAttached("Foreground", typeof(Brush), typeof(PressedHelper), new PropertyMetadata(null, async (s, a) =>
            {
                if (a.NewValue != a.OldValue)
                {
                    if (s is FrameworkElement ele)
        ...
        public static readonly DependencyProperty BorderBrushProperty =
            DependencyProperty.RegisterAttached("BorderBrush", typeof(Brush), typeof(PressedHelper), new PropertyMetadata(null, async (s, a) =>
            {
                if (a.NewValue != a.OldValue)
                {
                    if (s is FrameworkElement ele)
